...
now = now.strftime("%Y%m%d-%H%M") + '_20200815_'
...
dataset = 'T54SUD_20200815T012659_B0'
...
imagefile = city + '_bandnum_' + str(r) + '_clusternum_' + str(cluster_num) + '_' + now
...
#############
dataset = 'T54SUD_20210716T012701_B0'
now = now + '_0716_'
